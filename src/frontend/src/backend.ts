...
export class Backend implements backendInterface {
    ...
    async getOwnLevel(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getOwnLevel();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOwnProfile(): Promise<Player> {
        if (this.processError) {
            try {
    ...
    async getOwnWinRatePercentage(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getOwnWinRatePercentage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlayerProfile(arg0: Principal): Promise<Player> {
        if (this.processError) {
            try {
    ...
    async registerOrUpdateProfile(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitGameResult(arg0: GameResult): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitGameResult(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
